...
{    
    ...
    private bool $disable_checkout_basket;

    public function __construct($show_google_pay, $disable_basket) 
    {
        $this->show_google_pay = $show_google_pay;
        $this->disable_checkout_basket = $disable_basket;
    }
    ...
    {
        if($this->disable_checkout_basket) {
            return '';
        }
