...
⚠️ **Notice: Version 4.0.x is now deprecated.**  
A new release (4.1.x) is available, but it includes breaking changes.  
If you rely on legacy functionality, you can remain on the 4.0.x branch.  
...
* Deprecated the 4.0.x branch.
* Added admin notice informing users about the new 4.1.x major release.
