 ...
 */
function add_monek_id_mappings_section($sections): array
{
    $sections[MCWC_ConsignmentSettings::MERCHANT_MAPPING_SECTION_SLUG] = __('Consignment Monek IDs', 'monek-checkout');
    return $sections;
}
add_filter('woocommerce_get_sections_products', 'add_monek_id_mappings_section');
 ...
 */
function display_monek_id_mappings_section($settings, $current_section)
{
...
add_filter('woocommerce_get_settings_products', 'display_monek_id_mappings_section', 10, 2);
